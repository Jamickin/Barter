...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\jamic\OneDrive\Documents\GitHub\barter\Barter\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links.C:\\Users\\jamic\\OneDrive\\Documents\\GitHub\\barter\\Barter\\public\\storage','logging.default',
...
'debugbar.queries.explain','ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','listing.create','listing.store','listing.edit','listing.update',
'listing.destroy','listing.index','listing.show','login','login.store',
'logout','user-account.create','user-account.store','user-account.show','register.store',
'profile.show',);
